...
export function localBusinessSchema() {
  return {
    ...
    "description": "Language Academy Bangladesh is the best PTE coaching centre in Dhanmondi, Dhaka. We offer expert PTE Academic preparation, IELTS coaching, and Spoken English courses with AI-scored mock tests, small batches, and online & offline classes. Study abroad consulting for Australia, Canada & UK.",
    ...
    "knowsAbout": [
      ...
      "Study abroad consulting Australia Canada UK",
      "Online PTE course Bangladesh"
    ],
    "slogan": "Best PTE Coaching Centre in Dhaka, Bangladesh"
  };
}
...
export function websiteSchema() {
  return {
    ...
    "url": "https://languageacademy.com.bd",
    "description": "Best PTE coaching centre in Dhaka, Bangladesh. Expert PTE preparation with AI mock tests, IELTS coaching, online PTE courses, and study abroad consulting.",
