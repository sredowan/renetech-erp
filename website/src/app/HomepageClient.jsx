    ...
    <div className="bg-white min-h-screen">
            ...
            <div className="max-w-[560px] py-6">
              <AnimateOnScroll variant="slide-left">
                <span className="inline-flex items-center rounded-full bg-primary/10 border border-primary/20 px-5 py-1.5 text-[11px] font-bold uppercase tracking-[0.18em] text-primary mb-5">
                  #1 PTE Coaching Centre in Dhaka
                </span>
                ...
                <p className="mt-4 text-[15px] xl:text-base leading-[1.7] text-slate-600 max-w-[480px]">
                  Bangladesh's top-rated PTE coaching centre with AI-scored mock tests, expert trainers, and small batches. PTE practice online & offline. IELTS preparation and study abroad consulting for Australia, Canada & UK.
                </p>

                {/* Feature Pills â€” single row on desktop */}
                <div className="mt-5 flex flex-wrap gap-2.5">
                  {[
                    { label: "PTE Course & Mock Tests", icon: Target },
                    { label: "IELTS Coaching", icon: BookOpen },
        ...
        <div className="container-shell relative z-10 flex-1 flex flex-col py-6 sm:py-8">
          ...
          <AnimateOnScroll variant="fade-up">
            <p className="mt-3 text-center text-[13px] sm:text-[14px] leading-[1.6] text-slate-600 max-w-[400px] mx-auto">
              Top-rated PTE coaching with AI mock tests, expert trainers & small batches. PTE practice online & offline. IELTS preparation and study abroad consulting for Australia, Canada & UK.
            </p>
          </AnimateOnScroll>
      ...
      <section className="py-20 bg-white">
        <div className="container-shell">
          <div className="mb-12 text-center max-w-2xl mx-auto">
            <span className="text-sm font-bold uppercase tracking-widest text-primary mb-3 block">PTE & IELTS Courses in Dhaka</span>
            <h2 className="text-3xl font-extrabold text-slate-900 md:text-4xl">PTE Coaching Courses — Enroll in the Next Batch</h2>
            <p className="mt-4 text-slate-500">Expert PTE Academic preparation with AI-scored mock tests. IELTS coaching and Spoken English also available. Small batches (max 12 students). Online PTE course & offline classes in Dhanmondi, Dhaka.</p>
          </div>
      ...
      {blogs && blogs.length > 0 && (
        <section className="py-24 bg-slate-50">
          <div className="container-shell">
            <div className="mb-12 text-center max-w-2xl mx-auto">
              <span className="text-sm font-bold uppercase tracking-widest text-primary mb-3 block">PTE & IELTS Study Resources</span>
              <h2 className="text-3xl font-extrabold text-slate-900 md:text-4xl">PTE Practice Tips & IELTS Preparation Guides</h2>
              <p className="mt-4 text-slate-500">Expert PTE exam strategies, IELTS preparation tips, and study abroad guides from our trainers. Free resources to help you achieve your target score faster.</p>
            </div>
