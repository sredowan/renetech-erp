...
export const metadata = {
  title: "Contact Us | PTE Coaching Centre Dhaka & Study Abroad Consultation",
  description:
    "Contact the best PTE coaching centre in Dhaka. Get expert advice on your PTE course, IELTS preparation, PTE practice online, and study abroad consultation.",
  alternates: { canonical: "https://languageacademy.com.bd/contact" },
  openGraph: {
    title: "Contact Language Academy | PTE Coaching Centre Dhaka",
    description: "Get expert advice on your PTE course, IELTS preparation, PTE practice online, and study abroad consultation.",
    url: "https://languageacademy.com.bd/contact",
    images: [{ url: "/hero_banner.webp", width: 1200, height: 630, alt: "Contact Language Academy" }],
  },
};
