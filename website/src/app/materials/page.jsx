...
export const metadata = {
  title: "PTE Practice Online & Study Materials | Language Academy",
  description: "Access your premium online PTE course materials, AI mock tests, and IELTS study resources from the best PTE coaching centre in Dhaka.",
};
