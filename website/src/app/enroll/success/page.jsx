...
function SuccessContent() {
  ...
  const transactionId = searchParams.get('tran_id') || 'UNKNOWN';
...
export default function SuccessPage() {
  return (
    <Suspense fallback={<div className="pt-32 pb-24 min-h-screen bg-slate-50 flex items-center justify-center"><p>Loading...</p></div>}>
      <SuccessContent />
    </Suspense>
  );
}
