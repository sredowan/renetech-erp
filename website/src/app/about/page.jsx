...
export const metadata = {
  title: "About Us | Best PTE Coaching Centre Dhaka & Study Abroad Consultants",
  description:
    "Language Academy is the leading PTE coaching centre in Dhaka. Learn about our mission to provide the best PTE practice online, IELTS preparation, and expert study abroad services.",
  alternates: { canonical: "https://languageacademy.com.bd/about" },
  openGraph: {
    title: "About Language Academy | Best PTE Coaching Centre Dhaka",
    description: "Learn about our mission to provide the best PTE practice online, IELTS preparation, and expert study abroad services.",
    url: "https://languageacademy.com.bd/about",
    images: [{ url: "/hero_banner.webp", width: 1200, height: 630, alt: "About Language Academy" }],
  },
};
